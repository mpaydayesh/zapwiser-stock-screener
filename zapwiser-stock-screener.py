...
app.layout = html.Div([
    ...
    html.Header([
        html.Div([
            html.Nav([
                html.Div([
                    html.Img(src="https://raw.githubusercontent.com/mpaydayesh/zapwiser-website/main/assets/images/logo.svg", alt="Zapwiser Logo"),
                    html.Span("Zapwiser", className="logo-text")
                ], className="logo d-flex align-items-center"),
                html.Div([
                    html.A("Home", href="/", className="nav-link me-3"),
                    html.A("Tools", href="/tools", className="nav-link me-3"),
                    html.A("Insights", href="/blog", className="nav-link")
