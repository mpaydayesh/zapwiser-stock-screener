    ...
    html.Header([
        html.Div([
            html.Nav([
                ...
                html.Div([
                    html.A("Home", href="https://zapwiser.netlify.app/", className="nav-link me-3", target="_blank"),
                    html.A("Tools", href="https://zapwiser.netlify.app/tools.html", className="nav-link me-3", target="_blank"),
                    html.A("Insights", href="https://zapwiser.netlify.app/blog.html", className="nav-link", target="_blank")
